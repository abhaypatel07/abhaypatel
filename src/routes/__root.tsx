...
import { BackToTop, CursorGlow, ScrollProgress } from "@/components/site/effects";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: portfolio.personal.name },
      { property: "og:site_name", content: portfolio.seo.siteName },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          worksFor: { "@type": "Organization", name: portfolio.personal.company },
          email: `mailto:${portfolio.personal.email}`,
          address: portfolio.personal.location,
